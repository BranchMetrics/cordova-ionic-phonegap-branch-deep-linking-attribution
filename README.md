...
These steps were built following this guide and making some modifications https://github.com/dpa99c/cordova-plugin-firebasex#ios-specific 
1. Follow this guide to download your GoogleService-Info.plist file. Then add it to your Cordova project's root folder: 
...
4. Ensure your GoogleService-Info.plist file is added to your root project folder or the app will crash when it attempts to initializes Firebase.
        * Note: If you see an error that Xcode can't find the Google App ID in the GoogleService-Info.plist file...
        ... open Xcode and check the App -> Resources folder. Click on the GoogleService-Info.plist file. If the file is blank, just move the empty file to trash 
