cordova.define("io.branch.sdk.branch", function(require, exports, module) { (function() {// Input 0
...
// Input 1
var config = {link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api.branch.io", version:"1.5.8"}, WEB_BUILD = !1, CORDOVA_BUILD = !0, TITANIUM_BUILD = !1;
// Input 2
var Queue = function() {
  var a = [], b = function() {
    if (a.length) {
...
var COOKIE_DAYS = 365, BRANCH_KEY_PREFIX = "BRANCH_WEBSDK_KEY", storage, BranchStorage = function(a) {
  ...
  return "branch_session" == a ? a : BRANCH_KEY_PREFIX + a;
  ...
  return{getAll:function() {
    var a = {}, d;
    for (d in b) {
      0 == d.indexOf(BRANCH_KEY_PREFIX) && (a[trimPrefix(d)] = retrieveValue(b.getItem(d)));
    }
    return a;
  }, get:function(a) {
...
Branch.prototype.init = wrap(callback_params.CALLBACK_ERR_DATA, function(a, b, c) {
  ...
  if (g && g.session_id) {
    ...
    if (CORDOVA_BUILD || TITANIUM_BUILD) {
      ...
      if (TITANIUM_BUILD) {
        var m = require("io.branch.sdk"), l, n;
